...
for _,name in ipairs(names) do
 ...
 assert(#s.tags==1 and s.tags[1].name=='support' and s.tags[1].fromFrame.frameNumber==1 and s.tags[1].toFrame.frameNumber==4)
...
print('PASS Aseprite reopened Kira: four source/export poses, support tag, 100ms timing')
